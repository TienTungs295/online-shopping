            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="GET" action="{!! route('labelView') !!}" class="row g-3">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8 text-end">
                                <a href="{!! route('createLabelView') !!}" class="btn btn-primary btn-sm"><i
                                        class="bi bi-plus-lg me-1"></i> Thêm
                                    mới
                                </a>
                                <a href="{!! route('labelView') !!}" class="btn btn-primary btn-sm"><i
                        ...
                        <table class="table table-hover table-bordered text-center mt-4">
                            ...
                            <tbody>
                            @if(!$product_labels->isEmpty())
                                @foreach($product_labels as $data)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{!! route('deleteLabel',['id' => $data->id]) !!}" class="d-inline-block" method="POST">
                                            @csrf

                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="GET" action="{!! route('productView') !!}" class="row g-3">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-8 text-end">
                                    <a href="{!! route('createProductView') !!}" class="btn btn-primary btn-sm"><i
                                            class="bi bi-plus-lg me-1"></i> Thêm
                                        mới
                                    </a>
                                    <a href="{!! route('productView') !!}" class="btn btn-primary btn-sm"><i
                                ...
                                @if(!$products->isEmpty())
                                    @foreach($products as $data)
                                        <tr class="align-middle">
                                            ...
                                            <td>
                                                <a href="{!! route('updateProductView',['id' => $data->id]) !!}"
                                                   class="btn btn-info btn-sm text-white">
                                                    <i class="bi bi-pencil-square"></i>
                                                </a>
                                                <form action="{!! route('deleteProduct',['id' => $data->id]) !!}"

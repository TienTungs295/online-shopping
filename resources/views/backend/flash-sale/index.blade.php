            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="GET" action="{!! route('flashSaleView') !!}" class="row g-3">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8 text-end">
                                <a href="{!! route('createFlashSaleView') !!}" class="btn btn-primary btn-sm"><i
                                        class="bi bi-plus-lg me-1"></i> Thêm
                                    mới
                                </a>
                                <a href="{!! route('flashSaleView') !!}" class="btn btn-primary btn-sm"><i
                        ...
                        <table class="table table-hover table-bordered text-center mt-4">
                            ...
                            @foreach($flash_sales as $data)
                            <tr>
                                <th scope="row">{!!$data->id!!}</th>
                                <td>{!!$data->name!!}</td>
                                <td>{!!$data->updated_at->format('H:i:s d-m-Y')!!}</td>
                                <td>
                                    <a href="{!! route('updateFlashSaleView',['id' => $data->id]) !!}"
                                       class="btn btn-info btn-sm text-white">
                                        <i class="bi bi-pencil-square"></i>
                                    </a>
                                    <form action="{!! route('deleteFlashSale',['id' => $data->id]) !!}"

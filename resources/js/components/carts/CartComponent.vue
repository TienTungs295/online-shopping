                                ...
                                <table class="table" v-if="cartCount > 0">
                                    ...
                                    <tr v-for="(item, key) in cart">
                                        ...
                                        <td class="product-price" data-title="Giá">
                                            ...
                                            <del v-if="item.options.on_sale">{{ item.options.price }}</del>
                                        </td>
                                        ...
                                        <td class="product-subtotal" data-title="Thành tiền">{{ item.subtotal }}</td>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td class="cart_total_amount">{{ shippingFee }} VNĐ</td>
                                        </tr>
                                        <tr>
